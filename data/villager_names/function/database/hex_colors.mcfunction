data modify storage eden:name_db color.desert set value "FFF382"
data modify storage eden:name_db color.jungle set value "61FF4F"
data modify storage eden:name_db color.plains set value "D5E0DD"
data modify storage eden:name_db color.savanna set value "E08C6E"
